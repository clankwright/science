---
id: topic-interventions
topic: interventions
---

# Interventions

Drug, diet, or genetic manipulations that extend lifespan or healthspan.

## Canonical testbed
- [[papers/itp-nia]], [[papers/itp-mpd-portal]]

## Meta-analytic reanalyses
...
- [[papers/network-repurposing-aging]] — systematic hallmark-matched
  repurposing.
- [[papers/clockbase-agent-2025]] — autonomous AI agents scoring
  ~2M molecular profiles across ~43k perturbations.
- [[papers/agextend-2025]] — 1.1B-compound geroprotector screen.
